...
export default function ScrollIndicator() {
    ...
    return (
        ...
        >
            ...
            {/* Mouse Icon */}
            <div className="w-[20px] h-[32px] rounded-full border-2 border-slate-400/40 flex justify-center p-1 shadow-[0_0_15px_rgba(255,255,255,0.05)] transition-all duration-300 group-hover:border-cyan-400 group-hover:shadow-[0_0_25px_rgba(6,182,212,0.4)] bg-slate-950/30 animate-bounce will-change-transform">
